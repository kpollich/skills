...
description: >
  Canonical GitHub issue templates for all issue types: Project/Epic, Implementation Task,
  Bug, Enhancement. Imported by run-spike and write-technical-content.
---

# GitHub Issue Templates

Shared by `run-spike` and `write-technical-content`. Apply all rules from [VOICE.md](../run-spike/VOICE.md) to all output.
